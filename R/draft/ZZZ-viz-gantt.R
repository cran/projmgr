...
#'
#' @param issues Issues dataset from output of \code{tidytracker::parse_issue_overview}
#'
#' @return Gantt-type chart of closed issues
#' @import ggplot2
#' @export
#'
#' @examples
...
#'
#' @return Gantt-type chart of open issues
#' @import ggplot2
#' @export
#'
#' @examples
